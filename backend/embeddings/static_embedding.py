...
class StaticEmbedding(TokenEmbedding):
    ...
    Example::
        ...
        >>> from backend.embeddings import StaticEmbedding
    ...
    def _load_with_vocab(self, embed_filepath, vocab, dtype=np.float32, padding='<pad>', unknown='<unk>',
        ...
        :param vocab: 词表 :class:`~backend.Vocabulary` 类型，读取出现在vocab中的词的embedding。
        ...
        """
        assert isinstance(vocab, Vocabulary), "Only backend.Vocabulary is supported."

...
class TENER(nn.Module):
    ...
    def _forward(self, chars, target, bigrams=None, features=None, zen_input=None):
    ...
    def forward(self, chars, target, bigrams=None, features=None, zen_input=None):
        return self._forward(chars, target, bigrams, features, zen_input)

    def predict(self, chars, bigrams=None, features=None, zen_input=None):
        return self._forward(chars, target=None, bigrams=bigrams, features=features, zen_input=zen_input)
